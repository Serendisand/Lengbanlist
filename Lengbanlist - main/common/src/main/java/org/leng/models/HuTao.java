...
public void showHelp(MessageSink sender) {
    ...
    sender.sendMessage("§2✦ §b/lban remove <必填>玩家名 §7- §3移除封禁，知错能改就放过他们吧！");
    sender.sendMessage("§7  = §b/unban");
    sender.sendMessage("§2✦ §b/ban-ip [可选]-s <必填>IP地址 <必填>天数/auto <必填>原因 §7- §3封禁 IP 地址，别再捣乱了！");
    ...
    sender.sendMessage("§2✦ §b/kick <必填>玩家名 [可选]原因 §7- §3踢出捣乱的玩家！");
    sender.sendMessage("§2✦ §b/setban <必填>玩家名/IP <必填>时间/forever/auto <必填>原因 §7- §3修改封禁时间，不守规矩就别怪胡桃无情！");
    sender.sendMessage("§6§l◆ 查询信息");
    sender.sendMessage("§2✦ §b/lban check <必填>玩家名/IP §7- §3检查封禁状态，看看谁在捣乱！");
    sender.sendMessage("§2✦ §b/lban history <必填>玩家名 §7- §3翻翻案底，让胡桃瞧瞧！");
    sender.sendMessage("§7  = §b/history");
    sender.sendMessage("§2✦ §b/report <必填>玩家名 <必填>原因 §7- §3发现捣乱的家伙？快举报给胡桃！");
    sender.sendMessage("§2✦ §b/lban getip [可选]玩家名 §7- §3查询玩家 IP 地址，不填就查自己哒！");
    sender.sendMessage("§2✦ §b/lban alts <必填>玩家名 §7- §3揪出他的小号，一个都别想逃！");
    sender.sendMessage("§6§l◆ 审计与回滚");
    sender.sendMessage("§2✦ §b/lban audit [可选]操作人 §7- §3翻翻账本，看谁动了什么！");
    sender.sendMessage("§2✦ §b/lban audit export [可选]条数 §7- §3把账本打包带走~");
    sender.sendMessage("§2✦ §b/lban audit verify §7- §3查查账本有没有被涂改！");
    sender.sendMessage("§2✦ §b/lban sync §7- §3看看各服账本对不对齐！");
    sender.sendMessage("§2✦ §b/lban rollback <必填>操作人 <必填>开始时间 <必填>结束时间 [可选]操作类型 §7- §3把账翻回去！");
    ...
    sender.sendMessage("§2✦ §b/lban model <必填>模型名称 §7- §3切换模型，试试别的风格吧！");
