...
public void showHelp(MessageSink sender) {
    ...
    sender.sendMessage("§2✦ §b/lban add <玩家名> <天数> <原因> §7- §3添加封禁，维护秩序不容破坏。");
    sender.sendMessage("§7  = §b/ban");
    sender.sendMessage("§2✦ §b/lban remove <玩家名> §7- §3移除封禁，宽恕是美德。");
    ...
    sender.sendMessage("§2✦ §b/lban unmute <玩家名> §7- §3解除禁言，给予机会重新开始。");
    ...
    sender.sendMessage("§2✦ §b/setban <玩家名/IP> <时间/forever/auto> <原因> §7- §3修改封禁时间，优雅而公正。");
    sender.sendMessage("§6§l◆ 查询信息");
    sender.sendMessage("§2✦ §b/lban check <玩家名/IP> §7- §3检查封禁状态，优雅而公正。");
    sender.sendMessage("§2✦ §b/lban history <玩家名> §7- §3查看处罚记录，请过目。");
    sender.sendMessage("§7  = §b/history");
    sender.sendMessage("§2✦ §b/report <玩家名> <原因> §7- §3优雅地举报不守规矩的行为。");
