...
public void showHelp(MessageSink sender) {
    ...
    sender.sendMessage("§2✦ §b/lban add <玩家名> <天数> <原因> §7- §3加入黑名单！");
    sender.sendMessage("§7  = §b/ban");
    sender.sendMessage("§2✦ §b/lban remove <玩家名> §7- §3从黑名单中移除");
    sender.sendMessage("§7  = §b/unban");
    sender.sendMessage("§2✦ §b/ban-ip <IP地址> <天数> <原因> §7- §3封禁 IP 地址，别再划水啦！");
    sender.sendMessage("§2✦ §b/lban mute <玩家名> <原因> §7- §3禁言玩家，让他们安静一会儿！");
    sender.sendMessage("§7  = §b/mute");
    sender.sendMessage("§2✦ §b/lban unmute <玩家名> §7- §3解除禁言，可以继续说话啦！");
    ...
    sender.sendMessage("§2✦ §b/kick <玩家名> <原因> §7- §3踢出划水的家伙！");
    ...
    sender.sendMessage("§2✦ §b/lban history <玩家名> §7- §3查阅审判记录，本水神亲自过目！");
    sender.sendMessage("§7  = §b/history");
    sender.sendMessage("§2✦ §b/report <玩家名> <原因> §7- §3向本水神举报违规者！");
