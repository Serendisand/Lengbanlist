...
public class Nahida implements Model {
    ...
    public void showHelp(MessageSink sender) {
        ...
        sender.sendMessage("§2✦ §b/lban add [可选]-s <必填>玩家名 <必填>天数/auto <必填>原因 §7- §3添加封禁，世界树会记下这次选择。");
        sender.sendMessage("§7  = §b/ban");
        sender.sendMessage("§2✦ §b/lban remove <必填>玩家名 §7- §3移除封禁，愿新的枝芽重新生长。");
        sender.sendMessage("§7  = §b/unban");
        sender.sendMessage("§2✦ §b/ban-ip [可选]-s <必填>IP地址 <必填>天数/auto <必填>原因 §7- §3封禁 IP 地址，异常的信息流需要修剪。");
        sender.sendMessage("§2✦ §b/lban mute [可选]-s <必填>玩家名 <必填>时间/auto <必填>原因 §7- §3禁言玩家，让思绪先安静下来吧。");
        sender.sendMessage("§7  = §b/mute");
        sender.sendMessage("§2✦ §b/lban unmute [可选]-s <必填>玩家名 §7- §3解除禁言，愿他们说出更温柔的话语。");
        sender.sendMessage("§7  = §b/unmute");
        sender.sendMessage("§2✦ §b/lban warn <必填>玩家名 <必填>原因 §7- §3警告玩家，三次警告将触发自动封禁。");
        sender.sendMessage("§7  = §b/warn");
        sender.sendMessage("§2✦ §b/lban unwarn <必填>玩家名 §7- §3移除玩家警告，让记录回归平静。");
        sender.sendMessage("§7  = §b/unwarn");
        sender.sendMessage("§2✦ §b/kick <必填>玩家名 [可选]原因 §7- §3踢出玩家，让他们暂时离开梦境。");
        sender.sendMessage("§2✦ §b/setban <必填>玩家名/IP <必填>时间/forever/auto <必填>原因 §7- §3修改封禁时间，重新校准规则的天平。");
        sender.sendMessage("§6§l◆ 查询信息");
        sender.sendMessage("§2✦ §b/lban check <必填>玩家名/IP §7- §3检查封禁状态，读取世界树中的记录。");
        sender.sendMessage("§2✦ §b/lban history <必填>玩家名 §7- §3查询处罚历史，看看记忆里留下了什么。");
        sender.sendMessage("§7  = §b/history");
        sender.sendMessage("§2✦ §b/report <必填>玩家名 <必填>原因 §7- §3举报玩家，把异常的梦告诉纳西妲吧。");
        sender.sendMessage("§2✦ §b/lban getip [可选]玩家名 §7- §3查询玩家 IP 地址，不填就查看自己的哦。");
        sender.sendMessage("§2✦ §b/lban alts <必填>玩家名 §7- §3查看同一片叶子的其他投影。");
        sender.sendMessage("§6§l◆ 审计与回滚");
        sender.sendMessage("§2✦ §b/lban audit [可选]操作人 §7- §3查看世界树中的审计记忆。");
        sender.sendMessage("§2✦ §b/lban audit export [可选]条数 §7- §3把记忆抄录出来。");
        sender.sendMessage("§2✦ §b/lban audit verify §7- §3校验记忆是否完整。");
        sender.sendMessage("§2✦ §b/lban sync §7- §3看看各服务器的梦境是否一致。");
        sender.sendMessage("§2✦ §b/lban rollback <必填>操作人 <必填>开始时间 <必填>结束时间 [可选]操作类型 §7- §3温柔地修正过去的枝叶。");
        ...
        sender.sendMessage("§2✦ §b/lban model <必填>模型名称 §7- §3切换模型，去看看不同的梦吧。");
