...
public void showHelp(MessageSink sender) {
    ...
    sender.sendMessage("§2✦ §b/lban add <玩家名> <天数> <原因> §7- §3添加封禁，正义不容挑战！");
    sender.sendMessage("§7  = §b/ban");
    sender.sendMessage("§2✦ §b/lban remove <玩家名> §7- §3移除封禁，给予机会重新开始。");
    sender.sendMessage("§7  = §b/unban");
    sender.sendMessage("§2✦ §b/ban-ip <IP地址> <天数> <原因> §7- §3封禁 IP 地址，维护正义。");
    sender.sendMessage("§2✦ §b/lban mute <玩家名> <原因> §7- §3禁言玩家，维护正义。");
    ...
    sender.sendMessage("§2✦ §b/kick <玩家名> <原因> §7- §3踢出不听话的家伙！");
    sender.sendMessage("§2✦ §b/setban <玩家名/IP> <时间/forever/auto> <原因> §7- §3修改封禁时间，调皮捣蛋可是要额外收费的~");
    sender.sendMessage("§6§l◆ 查询信息");
    sender.sendMessage("§2✦ §b/lban check <玩家名/IP> §7- §3检查封禁状态，希儿的正义不容挑战！");
    sender.sendMessage("§2✦ §b/lban history <玩家名> §7- §3翻翻黑历史，让希儿瞧瞧~");
    sender.sendMessage("§7  = §b/history");
    sender.sendMessage("§2✦ §b/report <玩家名> <原因> §7- §3维护正义，举报违规者！");
