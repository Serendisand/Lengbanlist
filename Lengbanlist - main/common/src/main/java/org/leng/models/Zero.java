...
public void showHelp(MessageSink sender) {
    ...
    sender.sendMessage("§2✦ §b/lban add [可选]-s <必填>玩家名 <必填>天数/auto <必填>原因 §7- §3添加封禁，零的秩序不容破坏！");
    sender.sendMessage("§7  = §b/ban");
    sender.sendMessage("§2✦ §b/lban remove <必填>玩家名 §7- §3移除封禁，给予机会。");
    ...
    sender.sendMessage("§2✦ §b/lban check <必填>玩家名/IP §7- §3检查封禁状态，维护秩序。");
    sender.sendMessage("§2✦ §b/lban history <必填>玩家名 §7- §3查询秩序档案，一切记录在案。");
    sender.sendMessage("§7  = §b/history");
    sender.sendMessage("§2✦ §b/report <必填>玩家名 <必填>原因 §7- §3维护秩序，举报违规者。");
    sender.sendMessage("§2✦ §b/lban getip [可选]玩家名 §7- §3查询玩家 IP 地址，不填则查自己。");
    sender.sendMessage("§2✦ §b/lban alts <必填>玩家名 §7- §3查询同 IP 小号，记录在案。");
