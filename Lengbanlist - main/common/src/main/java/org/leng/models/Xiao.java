...
public void showHelp(MessageSink sender) {
    ...
    sender.sendMessage("§2✦ §b/setban <必填>玩家名/IP <必填>时间/forever/auto <必填>原因 §7- §3修改封禁时间，让不守规矩的人好好反省！");
    sender.sendMessage("§6§l◆ 查询信息");
    sender.sendMessage("§2✦ §b/lban check <必填>玩家名/IP §7- §3检查封禁状态，看看谁在捣乱！");
    sender.sendMessage("§2✦ §b/lban history <必填>玩家名 §7- §3查看业障记录，让我瞧瞧……");
    sender.sendMessage("§7  = §b/history");
    sender.sendMessage("§2✦ §b/report <必填>玩家名 <必填>原因 §7- §3发现捣乱的家伙？快举报给魈！");
    sender.sendMessage("§2✦ §b/lban getip [可选]玩家名 §7- §3查询玩家 IP 地址，不填就查自己。");
    sender.sendMessage("§2✦ §b/lban alts <必填>玩家名 §7- §3查同 IP 小号，一个都跑不掉！");
    sender.sendMessage("§6§l◆ 审计与回滚");
    sender.sendMessage("§2✦ §b/lban audit [可选]操作人 §7- §3查看业障的总账。");
    sender.sendMessage("§2✦ §b/lban audit export [可选]条数 §7- §3把账本导出。");
    sender.sendMessage("§2✦ §b/lban audit verify §7- §3校验收录有没有被动手脚。");
    sender.sendMessage("§2✦ §b/lban sync §7- §3看看各服同步情况。");
    sender.sendMessage("§2✦ §b/lban rollback <必填>操作人 <必填>开始时间 <必填>结束时间 [可选]操作类型 §7- §3把过去的事翻回来。");
