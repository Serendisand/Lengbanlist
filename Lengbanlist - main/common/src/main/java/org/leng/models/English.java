...
public class English implements Model {
    ...
    public void showHelp(MessageSink sender) {
        ...
        sender.sendMessage("§2✦ §b/lban add <player> <days> <reason> §7- §3Ban a player");
        sender.sendMessage("§7  = §b/ban");
        sender.sendMessage("§2✦ §b/lban remove <player> §7- §3Unban a player");
        sender.sendMessage("§7  = §b/unban");
        sender.sendMessage("§2✦ §b/ban-ip <IP> <days> <reason> §7- §3Ban an IP address");
        sender.sendMessage("§2✦ §b/lban mute <player> <reason> §7- §3Mute a player");
        sender.sendMessage("§7  = §b/mute");
        sender.sendMessage("§2✦ §b/lban unmute <player> §7- §3Unmute a player");
        sender.sendMessage("§7  = §b/unmute");
        sender.sendMessage("§2✦ §b/lban warn <player> <reason> §7- §3Warn a player, 3 = auto-ban");
        sender.sendMessage("§7  = §b/warn");
        sender.sendMessage("§2✦ §b/lban unwarn <player> §7- §3Remove player warnings");
        sender.sendMessage("§7  = §b/unwarn");
        sender.sendMessage("§2✦ §b/kick <player> <reason> §7- §3Kick a player");
        sender.sendMessage("§2✦ §b/setban <player/IP> <time/forever/auto> <reason> §7- §3Modify ban time");
        sender.sendMessage("§6§l◆ Information");
        sender.sendMessage("§2✦ §b/lban check <player/IP> §7- §3Check ban status");
        sender.sendMessage("§2✦ §b/lban history <player> §7- §3Query punishment history");
        sender.sendMessage("§7  = §b/history");
        sender.sendMessage("§2✦ §b/report <player> <reason> §7- §3Report a player");
        sender.sendMessage("§2✦ §b/lban getip <player> §7- §3Query player IP address");
        ...
        sender.sendMessage("§2✦ §b/lban model <model> §7- §3Switch model");
