...
public void showHelp(MessageSink sender) {
    ...
    sender.sendMessage("§2✦ §b/lban add <玩家名> <天数> <原因> §7- §3添加封禁，秩序不容破坏。");
    ...
    sender.sendMessage("§2✦ §b/lban unmute <玩家名> §7- §3解除禁言，宽恕是美德。");
    ...
    sender.sendMessage("§2✦ §b/kick <玩家名> <原因> §7- §3踢出破坏秩序的玩家！");
    sender.sendMessage("§2✦ §b/setban <玩家名/IP> <时间/forever/auto> <原因> §7- §3修改封禁时间，维护秩序。");
    sender.sendMessage("§6§l◆ 查询信息");
    sender.sendMessage("§2✦ §b/lban check <玩家名/IP> §7- §3检查封禁状态，一切尽在掌控。");
    sender.sendMessage("§2✦ §b/lban history <玩家名> §7- §3查阅契约档案，凡违契者皆记录在案。");
    sender.sendMessage("§7  = §b/history");
    sender.sendMessage("§2✦ §b/report <玩家名> <原因> §7- §3发现破坏秩序的行为？及时举报。");
