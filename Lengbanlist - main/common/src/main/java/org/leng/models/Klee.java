...
public class Klee implements Model {
    ...
    public void showHelp(MessageSink sender) {
        String[] lines = {
                ...
                "§c╠══════════════════════════════════╣",
                "§6§l◆ 处罚管理",
                "§e✦ §b/lban add [可选]-s <必填>玩家名 <必填>天数/auto <必填>原因 §7- §3添加封禁，坏孩子要去禁闭室啦！",
                "§7  = §b/ban",
                "§e✦ §b/lban remove <必填>玩家名 §7- §3移除封禁，这次就原谅你啦！",
                "§7  = §b/unban",
                "§e✦ §b/ban-ip [可选]-s <必填>IP地址 <必填>天数/auto <必填>原因 §7- §3封禁 IP，不许偷偷回来捣蛋！",
                "§e✦ §b/lban mute [可选]-s <必填>玩家名 <必填>时间/auto <必填>原因 §7- §3禁言玩家，要安静一点哦！",
                "§7  = §b/mute",
                ...
                "§e✦ §b/lban getip [可选]玩家名 §7- §3查询玩家 IP 地址，不填就查自己哦。",
                "§e✦ §b/lban alts <必填>玩家名 §7- §3看看他还有几个小号躲猫猫。",
                "§6§l◆ 审计与回滚",
                "§e✦ §b/lban audit [可选]操作人 §7- §3看看谁动了什么。",
                "§e✦ §b/lban audit export [可选]条数 §7- §3把记录抄回家。",
                "§e✦ §b/lban audit verify §7- §3检查记录有没有被乱涂。",
                "§e✦ §b/lban sync §7- §3看看别的服务器是不是一样哒。",
                "§e✦ §b/lban rollback <必填>操作人 <必填>开始时间 <必填>结束时间 [可选]操作类型 §7- §3把捣乱的事拆掉！",
                "§6§l◆ 杂项",
                ...
                "§c╚══════════════════════════════════╝",
                "§e♡ 当前版本: " + PlatformHolder.get().getPluginVersion() + " §7| §b模型: 可莉 Klee"
        };
