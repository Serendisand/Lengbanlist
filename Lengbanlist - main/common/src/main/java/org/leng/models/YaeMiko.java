...
public class YaeMiko implements Model {
    ...
    public void showHelp(MessageSink sender) {
        String[] lines = {
                ...
                "§d╠══════════════════════════════════╣",
                "§6§l◆ 处罚管理",
                "§5✦ §b/lban add [可选]-s <必填>玩家名 <必填>天数/auto <必填>原因 §7- §3添加封禁，哎呀，又有有趣的家伙了呢。",
                "§7  = §b/ban",
                "§5✦ §b/lban remove <必填>玩家名 §7- §3移除封禁，给他一点改过机会吧。",
                "§7  = §b/unban",
                "§5✦ §b/ban-ip [可选]-s <必填>IP地址 <必填>天数/auto <必填>原因 §7- §3封禁 IP，别以为换个壳就认不出来哦。",
                "§5✦ §b/lban mute [可选]-s <必填>玩家名 <必填>时间/auto <必填>原因 §7- §3禁言玩家，让耳根清净一会儿。",
                "§7  = §b/mute",
                ...
                "§5✦ §b/lban getip [可选]玩家名 §7- §3查询玩家 IP 地址，不填就查自己啦。",
                "§5✦ §b/lban alts <必填>玩家名 §7- §3看看他还有几个替身呢。",
                "§6§l◆ 审计与回滚",
                "§5✦ §b/lban audit [可选]操作人 §7- §3翻阅剧本的幕后台账。",
                "§5✦ §b/lban audit export [可选]条数 §7- §3把台账带回家慢慢看。",
                "§5✦ §b/lban audit verify §7- §3检查台账有没有被撕页。",
                "§5✦ §b/lban sync §7- §3各分剧场的数据是否对齐。",
                "§5✦ §b/lban rollback <必填>操作人 <必填>开始时间 <必填>结束时间 [可选]操作类型 §7- §3重演某段剧本。",
                "§6§l◆ 杂项",
                ...
                "§d╚══════════════════════════════════╝",
                "§d♡ 当前版本: " + PlatformHolder.get().getPluginVersion() + " §7| §b模型: 八重神子 YaeMiko"
        };
