...
public void showHelp(MessageSink sender) {
    ...
    sender.sendMessage("§2✦ §b/lban remove <玩家名> §7- §3移除封禁，知错能改善莫大焉！");
    sender.sendMessage("§7  = §b/unban");
    sender.sendMessage("§2✦ §b/ban-ip <IP地址> <天数> <原因> §7- §3封禁 IP 地址，刻晴绝不手软！");
    ...
    sender.sendMessage("§2✦ §b/setban <玩家名/IP> <时间/forever/auto> <原因> §7- §3修改封禁时间，效率第一！");
    sender.sendMessage("§6§l◆ 查询信息");
    sender.sendMessage("§2✦ §b/lban check <玩家名/IP> §7- §3检查封禁状态，刻晴办事效率第一！");
    sender.sendMessage("§2✦ §b/lban history <玩家名> §7- §3调出处罚档案，一目了然！");
    sender.sendMessage("§7  = §b/history");
    sender.sendMessage("§2✦ §b/report <玩家名> <原因> §7- §3发现违规行为？及时举报，刻晴会高效处理！");
    ...
    sender.sendMessage("§2✦ §b/lban model <模型名称> §7- §3切换模型，试试不同的风格吧！");
